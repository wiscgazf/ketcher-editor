module.exports = [
    ...
    { search: 'title:"Structure Library"', replace: 'title:"结构库"' },
    // right bar
    { search: 'title:"Hydrogen"', replace: 'title:"氢"' },
    { search: 'title:"Carbon"', replace: 'title:"碳"' },
    { search: 'title:"Nitrogen"', replace: 'title:"氮"' },
    { search: 'title:"Oxygen"', replace: 'title:"氧"' },
    { search: 'title:"Sulfur"', replace: 'title:"硫"' },
    { search: 'title:"Phosphorus"', replace: 'title:"磷"' },
    { search: 'title:"Fluorine"', replace: 'title:"氟"' },
    { search: 'title:"Chlorine"', replace: 'title:"氯"' },
    { search: 'title:"Bromine"', replace: 'title:"溴"' },
    { search: 'title:"Iodine"', replace: 'title:"碘"' },
    ...
    { search: 'errorTitle:"Error Message"', replace: 'errorTitle:"错误"' },
    { search: 'title:"Error message"', replace: 'title:"错误"' },
    { search: 'Save Structure', replace: '保存结构' },
    { search: 'File name', replace: '文件名称' },
    { search: 'title:"File format:"', replace: 'title:"文件格式:"' },
    ...
    { search: '"Paste",', replace: '"粘贴",' },
    { search: 'SO("Paste")', replace: 'SO("粘贴")' },
    { search: 'Text Editor', replace: '文本编辑' },
    { search: 'title:"symbols"', replace: 'title:"符号"' },
    { search: 'Font Size', replace: '字体大小' },
    { search: '{OK:"Apply"},buttons:["Cancel","OK"]', replace: '{OK:"确定"},buttons:["取消","OK"]' },
    // 在源码处修改，采用App.vue 中定义的变量
    { search: 'U.button.command.toLowerCase()', replace: 'window.jbyFonts[U.button.command]' },
    ...
    { search: 'title:"Rotation Step,', replace: 'title:"旋转步长,' },
    ...
    { search: '{U.high="600",U.low="72"}', replace: '{U["高"]="600",U["低"]="72"}' },
    { search: 'default:cv.low', replace: 'default:cv["低"]' },
    { search: 'Show the Stereo flags', replace: '显示立体标志' },
    { search: '"Label display at\\xa0stereogenic\\xa0centers"', replace: '"立体中心的标志显示"' },
    { search: '["IUPAC style","Classic","On","Off"]', replace: '["IUPAC 风格","经典风格","打开","关闭"]' },
    ...
    { search: '["Labels Only","Bonds Only","Labels And Bonds","Off"]', replace: '["仅标签","仅键","标签和键","关闭"]' },
    ...
    {
        search: 'U.Off="Off",U.Hetero="Hetero",U.Terminal="Terminal",U.TerminalAndHetero="Terminal and Hetero",U.On="On"',
        replace: 'U.Off="关闭",U.Hetero="显示非碳元素氢键",U.Terminal="显示末端氢键",U.TerminalAndHetero="显示非碳元素氢键+末端氢键",U.On="打开"'
    },
    ...
    { search: '["Lines","Balls and Sticks","Licorice"]', replace: '["线框模型","球棍模型","棒状模型"]' },
    { search: 'Background color', replace: '背景颜色' },
    { search: '["Light","Dark"]', replace: '["白色","黑色"]' },
    { search: 'Label coloring', replace: '标签着色' },
    { search: '["No","Bright","Black and White","Black"]', replace: '["打开","明亮","黑白","黑"]' },
    ...
    { search: 'title:"Helium"', replace: 'title:"氦"' },
    { search: 'title:"Lithium"', replace: 'title:"锂"' },
    { search: 'title:"Beryllium"', replace: 'title:"铍"' },
    { search: 'title:"Boron"', replace: 'title:"硼"' },
    { search: 'title:"Neon"', replace: 'title:"氖"' },
    { search: 'title:"Sodium"', replace: 'title:"钠"' },
    { search: 'title:"Magnesium"', replace: 'title:"镁"' },
    { search: 'title:"Aluminium"', replace: 'title:"铝"' },
    { search: 'title:"Silicon"', replace: 'title:"硅"' },
    { search: 'title:"Argon"', replace: 'title:"氩"' },
    { search: 'title:"Potassium"', replace: 'title:"钾"' },
    { search: 'title:"Calcium"', replace: 'title:"钙"' },
    { search: 'title:"Scandium"', replace: 'title:"钪"' },
    { search: 'title:"Titanium"', replace: 'title:"钛"' },
    { search: 'title:"Vanadium"', replace: 'title:"钒"' },
    { search: 'title:"Chromium"', replace: 'title:"铬"' },
    { search: 'title:"Manganese"', replace: 'title:"锰"' },
    { search: 'title:"Manganese"', replace: 'title:"锰"' },
    { search: 'title:"Iron"', replace: 'title:"铁"' },
    { search: 'title:"Cobalt"', replace: 'title:"钴"' },
    { search: 'title:"Nickel"', replace: 'title:"镍"' },
    { search: 'title:"Copper"', replace: 'title:"铜"' },
    { search: 'title:"Zinc"', replace: 'title:"锌"' },
    { search: 'title:"Gallium"', replace: 'title:"镓"' },
    { search: 'title:"Germanium"', replace: 'title:"锗"' },
    { search: 'title:"Arsenic"', replace: 'title:"砷"' },
    { search: 'title:"Selenium"', replace: 'title:"硒"' },
    { search: 'title:"Krypton"', replace: 'title:"氪"' },
    { search: 'title:"Rubidium"', replace: 'title:"铷"' },
    { search: 'title:"Strontium"', replace: 'title:"锶"' },
    { search: 'title:"Yttrium"', replace: 'title:"钇"' },
    { search: 'title:"Zirconium"', replace: 'title:"锆"' },
    { search: 'title:"Niobium"', replace: 'title:"铌"' },
    { search: 'title:"Molybdenum"', replace: 'title:"钼"' },
    { search: 'title:"Technetium"', replace: 'title:"锝"' },
    { search: 'title:"Ruthenium"', replace: 'title:"钌"' },
    { search: 'title:"Rhodium"', replace: 'title:"铑"' },
    { search: 'title:"Palladium"', replace: 'title:"钯"' },
    { search: 'title:"Silver"', replace: 'title:"银"' },
    { search: 'title:"Cadmium"', replace: 'title:"镉"' },
    { search: 'title:"Indium"', replace: 'title:"铟"' },
    { search: 'title:"Tin"', replace: 'title:"锡"' },
    { search: 'title:"Antimony"', replace: 'title:"锑"' },
    { search: 'title:"Tellurium"', replace: 'title:"碲"' },
    { search: 'title:"Xenon"', replace: 'title:"氙"' },
    { search: 'title:"Caesium"', replace: 'title:"铯"' },
    { search: 'title:"Barium"', replace: 'title:"钡"' },
    { search: 'title:"Lanthanum"', replace: 'title:"镧"' },
    { search: 'title:"Cerium"', replace: 'title:"铈"' },
    { search: 'title:"Praseodymium"', replace: 'title:"镨"' },
    { search: 'title:"Neodymium"', replace: 'title:"钕"' },
    { search: 'title:"Promethium"', replace: 'title:"钷"' },
    { search: 'title:"Samarium"', replace: 'title:"钐"' },
    { search: 'title:"Europium"', replace: 'title:"铕"' },
    { search: 'title:"Gadolinium"', replace: 'title:"钆"' },
    { search: 'title:"Terbium"', replace: 'title:"铽"' },
    { search: 'title:"Dysprosium"', replace: 'title:"镝"' },
    { search: 'title:"Holmium"', replace: 'title:"钬"' },
    { search: 'title:"Erbium"', replace: 'title:"铒"' },
    { search: 'title:"Thulium"', replace: 'title:"铥"' },
    { search: 'title:"Ytterbium"', replace: 'title:"镱"' },
    { search: 'title:"Lutetium"', replace: 'title:"镥"' },
    { search: 'title:"Hafnium"', replace: 'title:"铪"' },
    { search: 'title:"Tantalum"', replace: 'title:"钽"' },
    { search: 'title:"Tungsten"', replace: 'title:"钨"' },
    { search: 'title:"Rhenium"', replace: 'title:"铼"' },
    { search: 'title:"Osmium"', replace: 'title:"锇"' },
    { search: 'title:"Iridium"', replace: 'title:"铱"' },
    { search: 'title:"Platinum"', replace: 'title:"铂"' },
    { search: 'title:"Gold"', replace: 'title:"金"' },
    { search: 'title:"Mercury"', replace: 'title:"汞"' },
    { search: 'title:"Thallium"', replace: 'title:"铊"' },
    { search: 'title:"Lead"', replace: 'title:"铅"' },
    { search: 'title:"Bismuth"', replace: 'title:"铋"' },
    { search: 'title:"Polonium"', replace: 'title:"钋"' },
    { search: 'title:"Astatine"', replace: 'title:"砹"' },
    { search: 'title:"Radon"', replace: 'title:"氡"' },
    { search: 'title:"Francium"', replace: 'title:"钫"' },
    { search: 'title:"Radium"', replace: 'title:"镭"' },
    { search: 'title:"Actinium"', replace: 'title:"锕"' },
    { search: 'title:"Thorium"', replace: 'title:"钍"' },
    { search: 'title:"Protactinium"', replace: 'title:"镤"' },
    { search: 'title:"Uranium"', replace: 'title:"铀"' },
    { search: 'title:"Neptunium"', replace: 'title:"镎"' },
    { search: 'title:"Plutonium"', replace: 'title:"钚"' },
    { search: 'title:"Americium"', replace: 'title:"镅"' },
    { search: 'title:"Curium"', replace: 'title:"锔"' },
    { search: 'title:"Berkelium"', replace: 'title:"锫"' },
    { search: 'title:"Californium"', replace: 'title:"锎"' },
    { search: 'title:"Einsteinium"', replace: 'title:"锿"' },
    { search: 'title:"Fermium"', replace: 'title:"镄"' },
    { search: 'title:"Mendelevium"', replace: 'title:"钔"' },
    { search: 'title:"Nobelium"', replace: 'title:"锘"' },
    { search: 'title:"Lawrencium"', replace: 'title:"铹"' },
    { search: 'title:"Rutherfordium"', replace: 'title:"𬬻"' },
    { search: 'title:"Dubnium"', replace: 'title:"𬭊"' },
    { search: 'title:"Seaborgium"', replace: 'title:"𬭳"' },
    { search: 'title:"Bohrium"', replace: 'title:"𬭛"' },
    { search: 'title:"Hassium"', replace: 'title:"𬭶"' },
    { search: 'title:"Meitnerium"', replace: 'title:"鿏"' },
    { search: 'title:"Darmstadtium"', replace: 'title:"𫟼"' },
    { search: 'title:"Roentgenium"', replace: 'title:"𬬭"' },
    { search: 'title:"Copernicium"', replace: 'title:"鿔"' },
    { search: 'title:"Nihonium"', replace: 'title:"鿭"' },
    { search: 'title:"Flerovium"', replace: 'title:"𫓧"' },
    { search: 'title:"Moscovium"', replace: 'title:"镆"' },
    { search: 'title:"Livermorium"', replace: 'title:"𫟷"' },
    { search: 'title:"Tennessine"', replace: 'title:"鿬"' },
    { search: 'title:"Oganesson"', replace: 'title:"鿫"' },
    { search: 'title:"Single"', replace: 'title:"单一"' },
    { search: 'title:"List"', replace: 'title:"列表"' },
    { search: 'title:"Not List"', replace: 'title:"非列表"' },
    { search: '["Cancel","OK"],buttonsNameMap:{OK:"Add"}', replace: '["取消","OK"],buttonsNameMap:{OK:"添加"}' },
    { search: '["Cancel","OK"],buttonsNameMap:{OK:"Apply"}', replace: '["取消","OK"],buttonsNameMap:{OK:"确定"}' },
    { search: 'children:"Structure Library"', replace: 'children:"结构库"' },
    ...
    { search: 'Click to add to canvas', replace: '单击以添加到画布' },
    ...
    { search: 'title:"Ring bond count"', replace: 'title:"环键计数"' },
    { search: 'As drawn', replace: '如图所示' },
    { search: 'title:"H count"', replace: 'title:"H计数"' },
    { search: 'title:"Substitution count"', replace: 'title:"替换计数"' },
    ...
    { search: 'Repeat Pattern', replace: '重复模式' },
    { search: '["Head-to-tail","Head-to-head","Either unknown"]', replace: '["头对尾","头对头","Either unknown"]' },
    ...
    { search: 'children:"Add attachment point"', replace: 'children:"添加附着点"' },
    { search: 'children:"Remove attachment point"', replace: 'children:"移除附着点"' },
    { search: 'F||"none"', replace: 'F||"无"' },
